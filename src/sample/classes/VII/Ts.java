...
public class Ts extends Button {
    public Ts(){
        WebShower webShower = new WebShower();
        Tooltip tooltip = new Tooltip("Tennessee");
        this.setText("Ts");
        this.setTooltip(tooltip);
        this.setTranslateX(680);
        this.setTranslateY(360);
        this.setPrefSize(40,40);
        this.setBackground(new Background(new BackgroundFill(Color.valueOf("#112e44"),new CornerRadii(5), Insets.EMPTY)));
        this.setTextFill(Color.LIGHTGREY);
        this.setOnAction((ActionEvent e) -> {
            webShower.setHtmlPath("wepPage/VII/ts.html");
            webShower.load();
        });
